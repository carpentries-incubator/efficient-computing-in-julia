...
# ╔═╡ 1ad3aefc-bd71-11ef-3bc2-6be273103bf2
using oneAPI

# ╔═╡ 285931ee-4f7a-4764-b0fd-6eb9bbb8cc92
using KernelAbstractions

# ╔═╡ 668e0ce2-b572-498d-926b-e5b28590e91d
using Images

# ╔═╡ 58d3f492-53da-4b03-a371-3f3319abf20a
using BenchmarkTools

# ╔═╡ bab8edb8-de9e-4f5b-94b2-b87dbe7cdff3
using GLMakie

# ╔═╡ 3b24ebbd-ffa1-40d8-a48b-23f7ce3c4969
...
# ╔═╡ 0580e9f5-119d-4d7c-b30f-e84df75a7410
c = -0.7269f0+0.1889f0im

# ╔═╡ 80a46311-dc76-4f7c-bd9c-5515e943141d
out = oneArray(zeros(Int, 1920, 1080))

# ╔═╡ 6ee694bc-021e-4b3e-9ffb-2bda96b19b25
backend = get_backend(out)

# ╔═╡ 71fa5293-daa0-4eb5-8180-2c51696faabb
size(out)

# ╔═╡ 90c5e01c-29c2-47f9-8eea-022d9d21a96b
@btime begin
	julia_dev(backend, 512)(c, 1f0/1000, 1024, out, ndrange=size(out))
	Matrix(out)
end

# ╔═╡ 467d4d05-6a9b-4656-a30a-2d213868b98a
julia_dev(backend, 512)(c, 1f0/600, 1024, out, ndrange=size(out))

# ╔═╡ 17e6d694-fb31-45bb-ae3c-717a430a8774
heatmap(Array(out))

# ╔═╡ 8b50d465-904f-4bf7-8b99-a51987003ac3
...
# ╔═╡ 453dbaf1-2665-4a06-a703-456cd3ae6fa1
out_host = zeros(Int, 1920, 1080)

# ╔═╡ 3da018af-24fa-4a0c-8ac2-05808f897dae
julia_dev(CPU(), 512)(c, 1f0/600, 1024, out_host, ndrange=size(out))

# ╔═╡ 69cb7c12-6f4d-461b-8402-c981f911c0aa
@btime julia_host(c, 1f0/1000, 1024, out_host)

# ╔═╡ 6c884332-ad1b-4570-99e4-8d510a754dc2
heatmap(out_host)

# ╔═╡ af11f88c-fbf2-4dc1-b807-ba6f26a19026
Threads.nthreads()

# ╔═╡ ac5cc60d-8842-4638-93a4-a6aec6455aad
devices()
...
manifest_format = "2.0"
project_hash = "96329b48b88409ae0ef18f078b1339e00225cc50"
...
[[deps.OpenCL_jll]]
deps = ["Artifacts", "JLLWrappers", "Libdl"]
git-tree-sha1 = "18cd7c6f95ad00c56ae0ca9eff6a757fc1424f79"
...
deps = ["Artifacts", "JLLWrappers", "LazyArtifacts", "Libdl", "TOML"]
git-tree-sha1 = "0a63c7a1a232014a696f3e770a69e14456fc5a82"
uuid = "85f0d8ed-5b39-5caa-b1ae-7472de402361"
version = "0.4.0+0"

[[deps.SPIRV_Tools_jll]]
deps = ["Artifacts", "JLLWrappers", "Libdl"]
git-tree-sha1 = "2b83d680fcaac47103f692bf903fd90af4f0f2ac"
...
[[deps.oneAPI]]
deps = ["Adapt", "CEnum", "ExprTools", "GPUArrays", "GPUCompiler", "KernelAbstractions", "LLVM", "Libdl", "LinearAlgebra", "NEO_jll", "Preferences", "Printf", "Random", "SPIRV_LLVM_Translator_unified_jll", "SPIRV_Tools_jll", "SparseArrays", "SpecialFunctions", "StaticArrays", "oneAPI_Level_Zero_Headers_jll", "oneAPI_Level_Zero_Loader_jll", "oneAPI_Support_jll"]
git-tree-sha1 = "55e1a4693354633b7846b41da6878f6720241b01"
...
deps = ["Artifacts", "JLLWrappers", "Libdl", "OpenCL_jll", "Pkg", "oneAPI_Level_Zero_Loader_jll"]
git-tree-sha1 = "6201bc968b1f228c71647c29253598cf5ed65470"
